...
func (c *core) checkMessage(msgCode uint64, view *ibft.View) error {
...
func toPriority(msgCode uint64, view *ibft.View) float32 {
	if msgCode == msgRoundChange {
