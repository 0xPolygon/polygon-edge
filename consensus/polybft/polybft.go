...
type pbftValidatorSet struct {
}

func newValidatorSet() *pbftValidatorSet {
	return &pbftValidatorSet{}
}

func (v *pbftValidatorSet) CalcProposer(round uint64) pbft.NodeID {
	return pbft.NodeID("")
}

func (v *pbftValidatorSet) Includes(id pbft.NodeID) bool {
	return false
}

func (v *pbftValidatorSet) Len() int {
	return 0
}

func (v *pbftValidatorSet) VotingPower() map[pbft.NodeID]uint64 {
	return nil
}
