...
//
// Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Go --no-wide-int --relax-primitive-carry-to-bitwidth 32,64 --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --doc-newline-in-typedef-bounds --doc-prepend-header 'Code generated by Fiat Cryptography. DO NOT EDIT.' --doc-text-before-function-name '' --doc-text-before-type-name '' --package-name fq '' 64 '2^256 - 2^224 + 2^192 - 89188191075325690597107910205041859247' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one
//
// curve description (via package name): fq
//
// machine_wordsize = 64 (from "64")
//
// requested operations: mul, square, add, sub, opp, from_montgomery, to_montgomery, nonzero, selectznz, to_bytes, from_bytes, one
//
...
func Mul(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x208 uint64
	var x209 uint64
	x208, x209 = bits.Sub64(x199, 0xbce6faada7179e84, uint64(uint1(x207)))
	var x210 uint64
	var x211 uint64
	x210, x211 = bits.Sub64(x201, 0xffffffffffffffff, uint64(uint1(x209)))
	var x212 uint64
	var x213 uint64
	x212, x213 = bits.Sub64(x203, 0xffffffff00000000, uint64(uint1(x211)))
	var x215 uint64
...
func Add(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x11 uint64
	var x12 uint64
	x11, x12 = bits.Sub64(x3, 0xbce6faada7179e84, uint64(uint1(x10)))
	var x13 uint64
	var x14 uint64
	x13, x14 = bits.Sub64(x5, 0xffffffffffffffff, uint64(uint1(x12)))
	var x15 uint64
	var x16 uint64
	x15, x16 = bits.Sub64(x7, 0xffffffff00000000, uint64(uint1(x14)))
	var x18 uint64
...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x12 uint64
	var x13 uint64
	x12, x13 = bits.Add64(x3, (x9 & 0xbce6faada7179e84), uint64(uint1(x11)))
	var x14 uint64
	var x15 uint64
	x14, x15 = bits.Add64(x5, x9, uint64(uint1(x13)))
	var x16 uint64
	x16, _ = bits.Add64(x7, (x9 & 0xffffffff00000000), uint64(uint1(x15)))
	out1[0] = x10
	out1[1] = x12
	out1[2] = x14
	out1[3] = x16
...
func FromMontgomery(out1 *NonMontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement) {
	...
	var x119 uint64
	var x120 uint64
	x119, x120 = bits.Sub64(x112, 0xbce6faada7179e84, uint64(uint1(x118)))
	var x121 uint64
	var x122 uint64
	x121, x122 = bits.Sub64(x114, 0xffffffffffffffff, uint64(uint1(x120)))
	var x123 uint64
	var x124 uint64
	x123, x124 = bits.Sub64(x116, 0xffffffff00000000, uint64(uint1(x122)))
	var x126 uint64
...
func ToMontgomery(out1 *MontgomeryDomainFieldElement, arg1 *NonMontgomeryDomainFieldElement) {
	...
	var x191 uint64
	var x192 uint64
	x191, x192 = bits.Sub64(x183, 0xbce6faada7179e84, uint64(uint1(x190)))
	var x193 uint64
	var x194 uint64
	x193, x194 = bits.Sub64(x185, 0xffffffffffffffff, uint64(uint1(x192)))
	var x195 uint64
	var x196 uint64
	x195, x196 = bits.Sub64(x187, 0xffffffff00000000, uint64(uint1(x194)))
	var x198 uint64
