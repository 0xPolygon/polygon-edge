...
type noDefined struct{}

func (n *noDefined) Gas(input []byte) uint64 {
	panic("not defined")
}

func (n *noDefined) Call(input []byte) ([]byte, error) {
	panic("not defined")
}
...
func (c *sha256hash) Gas(input []byte) uint64 {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bigModExp) Gas(input []byte) uint64 {
	var (
...
func (c *bigModExp) Call(input []byte) ([]byte, error) {
	var (
