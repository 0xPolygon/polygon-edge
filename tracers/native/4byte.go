...
type fourByteTracer struct {
	...
	activePrecompiles []types.Address // Updated on CaptureStart based on given rules
}
...
func (t *fourByteTracer) isPrecompiled(addr types.Address) bool {
...
func (t *fourByteTracer) CaptureStart(txn interface{}, from types.Address, to types.Address, create bool, input []byte, gas uint64, value *big.Int) {
	// t.env = env
...
func (t *fourByteTracer) CaptureState(pc uint64, op int, gas, cost uint64, scope *runtime.ScopeContext, rData []byte, depth int, err error) {
}

// CaptureEnter is called when EVM enters a new scope (via call, create or selfdestruct).
func (t *fourByteTracer) CaptureEnter(op int, from types.Address, to types.Address, input []byte, gas uint64, value *big.Int) {
...
func (t *fourByteTracer) CaptureFault(pc uint64, op int, gas, cost uint64, scope *runtime.ScopeContext, depth int, err error) {
}
