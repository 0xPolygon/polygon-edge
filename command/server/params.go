...
const (
	...
	bridgeFlag                       = "bridge"
	bridgeRootchainURLFlag           = "bridge-rootchain-url"
	bridgeRootchainContractFlag      = "bridge-rootchain-contract"
	bridgeRootchainConfirmationsFlag = "bridge-rootchain-confirmations"
)
